...
def get_sentences(train_data):
    ...
    for k, v in train_data.items():
        x = [xv["sentence"] for xv in v["annotation"]["annotations"]]
        all_sentences += x
...
def main():
    ...
    parser.add_argument("--dset_name", type=str, default="yc2", choices=["ymk", "yc2"])
    ...
    all_sentences = get_sentences(train_data)
